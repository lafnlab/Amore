...
CREATE TABLE `configuration` (
  ...
  `default_locale` tinytext NOT NULL DEFAULT 'en-US',
  `open_registrations` BOOLEAN DEFAULT 0 COMMENT 'default is closed',
  `admin_account` tinytext NOT NULL DEFAULT 'admin' COMMENT 'will be first account created',
  `admin_email` tinytext NOT NULL,
  `posts_are_called` tinttext NOT NULL DEFAULT 'posts',
  `post_is_called` tinytext NOT NULL DEFAULT 'post',
  `reposts_are_called` tinytext NOT NULL DEFAULT 'reposts',
  `repost_is_called` tinytext NOT NULL DEFAULT 'repost',
  `users_are_called` tinytext NOT NULL DEFAULT 'users',
  `user_is_called` tinytext NOT NULL DEFAULT 'user',
  `favorites_are_called` tinytext NOT NULL DEFAULT 'favorites',
  `favorite_is_called` tinytext NOT NULL DEFAULT 'favorite',
