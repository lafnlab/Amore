...
if (isset($_POST['eyesubmit'])) {
	...
	$idq = "SELECT * FROM eye_colors WHERE eye_colors_id=\'".$eyid."\'";
	$idquery = mysqli_query($dbconn,$idq);
	$message = $idq;
	if ($idquery == FALSE) {

		$eyaddq 	= "INSERT INTO eye_colors (eye_colors_id, eye_colors_color) VALUES ('$eyid','$eycolor')";
