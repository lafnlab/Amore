...
<!-- get lists of places based on their continent/region of the globe -->
		<article class="w3-col w3-panel w3-cell m9">
			<table class="w3-card-2 w3-theme-l3 w3-padding">
				<caption><?php echo _('Africa'); ?></caption>
<?php
...
<!--			<table class="w3-card-2 w3-theme-l3 w3-padding"> -->
<!--				<caption><?php echo _('Antarctica'); ?></caption> -->
...
<!--			</table> -->
			...
			<table class="w3-card-2 w3-theme-l3 w3-padding">
				<caption><?php echo _('Asia'); ?></caption>
<?php
...
?>
			...
			<table class="w3-card-2 w3-theme-l3 w3-padding">
				<caption><?php echo _('Caribbean'); ?></caption>
<?php
...
?>
			...
			<table class="w3-card-2 w3-theme-l3 w3-padding">
				<caption><?php echo _('Europe'); ?></caption><?php
...
?>
			...
			<table class="w3-card-2 w3-theme-l3 w3-padding">
				<caption><?php echo _('North America'); ?></caption>
<?php
...
?>
			...
			<table class="w3-card-2 w3-theme-l3 w3-padding">
				<caption><?php echo _('Oceania'); ?></caption>
<?php
...
?>
			...
			<table class="w3-card-2 w3-theme-l3 w3-padding">
				<caption><?php echo _('South America'); ?></caption>
<?php
